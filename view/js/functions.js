...
let data = JSON.stringify({
  ...
  return {auditedPeople:auditedPeople, auditsDoneCount:auditsDoneCount, auditsMissed:auditsMissed, allAudits:allAudits, fail:fail}
}

function splitString(word, from, to){
    var finalWord = ""
